export const en = {
    ...
    week_6_verbs: [
        {
            "id": 1,
            "original": "to work <b>as</b>",
            "translate": "pracować jako",
            "isActive": true
        },
        {
            "id": 2,
            "original": "to work <b>at</b>",
            "translate": "pracować w (konkretniej firmie)",
            "isActive": true
        },
        {
            "id": 3,
            "original": "to work <b>for</b>",
            "translate": "pracować dlia",
            "isActive": true
        },
        {
            "id": 4,
            "original": "to work <b>in</b>",
            "translate": "pracować w (budynku, in a libray, in the fashion industry)",
            "isActive": true
        },
        {
            "id": 5,
            "original": "to work <b>on</b>",
            "translate": "pracować nad",
            "isActive": true
        },
        {
            "id": 5,
            "original": "to put sth away",
            "translate": "odkładać, odstawiać coś, убирать вещь на место (Please put your toys away before dinner)",
            "isActive": true
        },
        {
            "id": 5,
            "original": "to put off",
            "translate": "przekladać (np. spotkanie), odrzucać",
            "isActive": true
        },
        {
            "id": 5,
            "original": "to put smt on",
            "translate": "zakladać (ubranie), nastawiać (wode na herbatę), włączać (muzykę)",
            "isActive": true
        },
        {
            "id": 5,
            "original": "to put out",
            "translate": "gasić (papierosa, pożar)",
            "isActive": true
        },
        {
            "id": 5,
            "original": "to put smt down",
            "translate": "kłaść, polożyć coś",
            "isActive": true
        },
        {
            "id": 5,
            "original": "to put sth in (to somewhere)",
            "translate": "wkładać coś (gdzieś) Вставлять или устанавливать что-то: Используется, когда требуется вставить что-то внутрь чего-то или на определенное место. Например, \"to put the key in the lock\" (вставить ключ в замок). Устанавливать или монтировать: В контексте установки оборудования, мебели и так далее. Например, \"to put in a new window\" (установить новое окно).",
            "isActive": true
        }
